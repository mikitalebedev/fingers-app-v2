...
public class TeoryWords extends AppCompatActivity {
    ...
    private String[] letters = {"Привет", "Пока", "Слово1", "Слово2", "Д", "Е", "Ж", "З", "И", "К", "Л", "М", "Н", "О", "П", "Р", "С", "Т", "У", "Ф", "Х", "Ц", "Ч", "Ш", "Щ", "Ь", "Э", "Ю", "Я"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teory_words);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentIndex < letters.length) {
                    ...
                    Intent intent = new Intent(TeoryWords.this, EndActivity.class);
